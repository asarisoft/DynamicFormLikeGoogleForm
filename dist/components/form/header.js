...
var _headerElement = require("./headerElement");
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } // header.js
var HeaderForm = /*#__PURE__*/function (_Component) {
  _inherits(HeaderForm, _Component);
  var _super = _createSuper(HeaderForm);
